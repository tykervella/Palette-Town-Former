...
const SearchCards = ({ onSearch }) => {
  ...
  useEffect(() => {
    ...
    const storedCardSubtype = localStorage.getItem('cardSubtype');
  ...
  const handleInputChange = (event) => {
    ...
    if (inputName === 'cardName') {
      ...
      localStorage.setItem('cardType', inputValue);
    } else if (inputName === 'cardSubtype') {
      setCardSubtype(inputValue);
      localStorage.setItem('cardSubtype', inputValue);
    } else if (inputName === 'cardColor') {
      setCardColor(inputValue);
      localStorage.setItem('cardColor', inputValue);
    }
  };
  ...
  const handleRefresh = () => {
    ...
    localStorage.removeItem('cardSubtype');
